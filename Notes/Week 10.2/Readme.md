# 📋 Table of Contents – Week 10.2: Understanding Prisma
...
2. [Object-Relational Mapping (ORM)](#Object-Relational-Mapping-(ORM))
   ...
   - [Official Definition](#nosql-databases)
   - [Simplified Definition](#graph-databases)
   - [Prisma as an ORM](#vector-databases)
   - [Why Use ORMs?](#sql-databases)

3. [Simpler Syntax](#why-not-nosql)
